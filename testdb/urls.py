...
from .views import PostListView, PostDetailView, PostDetailView2, PostListView3, PostListView4, PostListView5, PostListView2, PostUpdateView, PostDeleteView, UserPostListView
from . import views
